...
uint256 hashGenesisBlock("0x60e542e559711ba386ccf714b68457383a19e569e3819942f9cba9cf547e6694");
...
const string strMessageMagic = "Arekibocoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Arekibocoin: 1 days
static const int64 nTargetSpacing = 120; // Arekibocoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal arekibocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Arekibocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf78e7c85e185220d877f772a4fb814dc2f0986397efd931e031d59975eb80b7e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "On the 7th of Jan 2014 , The ArekiboCoin was born";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389113009; 
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1840800;

        if (fTestNet)
        {
            block.nTime    = 1389104724;
            block.nNonce   = 4140540;
        }
        ...
        assert(block.hashMerkleRoot == uint256("6d4226b39f4bc7c40e9b8d2de153e6c485ab60c16b24be534728f7b78e6b29bc"));
